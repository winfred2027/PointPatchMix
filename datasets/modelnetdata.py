...
class attention_ModelNet40(Dataset):
...
class ModelNet40Attention(Dataset):
    def __init__(self, split, data_path):
        ...
        self.dataset = attention_ModelNet40(**modelnet40_params)
    ...
    def __getitem__(self, idx):
        ...
        return 'ModelNet', 'sample', (data, label)
